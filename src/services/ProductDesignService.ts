...
.theme-dark .dashflow-view-container {
  --df-cmd-bg: color-mix(in srgb, var(--background-primary) 97%, #0e1215);
  --df-cmd-surface: var(--background-primary);
...
.dashflow-command-shell:not(.is-personal-home) .dashflow-command-bar::before { content: "DashFlow"; flex: 0 0 auto; padding: 0 9px 0 5px; color: var(--df-cmd-text); font-size: 12.5px; font-weight: 720; letter-spacing: -0.01em; }
...
.dashflow-command-button {
  position: relative; height: 30px; display: inline-flex; align-items: center; gap: 5px; padding: 0 10px; border: 1px solid transparent!important; border-radius: 7px!important; color: var(--df-cmd-muted)!important; background: transparent!important; box-shadow: none!important; font-size: 11.5px; font-weight: 600; white-space: nowrap; cursor: pointer; transition: color 150ms ease, background 150ms ease, border-color 150ms ease;
}
...
.dashflow-command-shell .dashflow-widget { overflow: hidden; border: 1px solid var(--df-cmd-border)!important; border-radius: 12px!important; background: var(--df-cmd-surface)!important; box-shadow: none!important; transform: none!important; transition: border-color 150ms ease, background 150ms ease!important; }
...
.dashflow-command-shell .dashflow-widget-header { height: 38px!important; padding: 0 12px!important; border-bottom: 1px solid var(--df-cmd-border)!important; background: transparent!important; }
...
.dashflow-command-shell .dashflow-project-row { min-height: 46px!important; padding: 6px 3px!important; display: grid!important; grid-template-columns: minmax(0, 1fr) minmax(130px, 220px) auto; align-items: center; gap: 14px; border: 0!important; border-bottom: 1px solid color-mix(in srgb, var(--df-cmd-border) 65%, transparent)!important; border-radius: 0!important; background: transparent!important; box-shadow: none!important; cursor: pointer; transition: background 120ms ease; }
...
.dashflow-command-page { min-height: 360px; padding: 16px; border: 1px solid var(--df-cmd-border); border-radius: 12px; background: var(--df-cmd-surface); box-shadow: none; }
...
.dashflow-command-page-head small { display: block; margin-bottom: 4px; color: var(--df-cmd-faint); font-size: 10px; font-weight: 600; letter-spacing: 0.08em; }
.dashflow-command-page-head h2 { margin: 0; color: var(--df-cmd-text); font-size: 19px; font-weight: 700; }
.dashflow-command-page-head button { height: 29px; padding: 0 11px; border: 1px solid var(--df-cmd-border); border-radius: 6px; color: var(--df-cmd-muted); background: transparent; font-size: 11px; font-weight: 600; cursor: pointer; transition: background 150ms ease; }
.dashflow-command-page-head button:hover { background: var(--df-cmd-soft); color: var(--df-cmd-text); }
.dashflow-command-inbox-composer { height: 40px; margin: 12px 0 10px; padding: 0 11px; display: grid; grid-template-columns: 16px minmax(0, 1fr) auto; align-items: center; gap: 9px; border: 1px solid var(--df-cmd-border); border-radius: 7px; background: var(--df-cmd-soft); }
