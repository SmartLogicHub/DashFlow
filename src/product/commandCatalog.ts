...
const FEATURE_COMMANDS: readonly CommandDefinition[] = [
  ...
  { id: "configure-workflow-context", name: "配置 Quick Capture 与情景模式", category: "feature", action: "workflow-settings", featureId: "workflow-settings" },
...
const MAINTENANCE_COMMANDS: readonly CommandDefinition[] = [
  { id: "export-active-dashboard", name: "导出当前 Dashboard JSON", category: "maintenance", action: "export-dashboard" },
  { id: "import-dashboard-json", name: "导入 Dashboard JSON", category: "maintenance", action: "import-dashboard" },
  { id: "reindex-vault", name: "重新索引 Vault", category: "maintenance", action: "reindex-vault" },
];
